...
namespace CandleNew.Forms
{
    ...
    {
        private PriceForMetal metal = new PriceForMetal();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                var price = metal.PricesForMetal[comboBox3.Text] * dollar.ReturnDollar() * koef.Koefs[comboBox2.Text];
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                var price = metal.PricesForMetal[comboBox1.Text] * dollar.ReturnDollar() * koef.Koefs[comboBox2.Text];
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                var price = metal.PricesForMetal[comboBox4.Text] * dollar.ReturnDollar() * koef.Koefs[comboBox2.Text];
